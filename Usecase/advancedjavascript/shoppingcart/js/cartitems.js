        ...
        if(this.readyState===4 && this.status===200){
            ...
            for(let i=0;i<len;i++){
                ...
                td2.appendChild(td2Text);
                 ...
                 let td3Text=  document.createTextNode(data[i].productName);
                td3.appendChild(td3Text);

                 let td4=  document.createElement("td");
                 let td4Text=  document.createTextNode(data[i].description);
                td4.appendChild(td4Text);

                 let td5=  document.createElement("td");
                 let td5Text=  document.createTextNode(data[i].price);
                td5.appendChild(td5Text);

                 let td6=  document.createElement("td");
                 let td6Text=  document.createTextNode(data[i].rating);
                td6.appendChild(td6Text);

                let td7=  document.createElement("td");
                 let td7Text=  document.createTextNode(data[i].quantity);
            ...
            table.appendChild(thead);
                ...
                let noDataText=document.createTextNode("CART ITEMS NOT FOUND");
